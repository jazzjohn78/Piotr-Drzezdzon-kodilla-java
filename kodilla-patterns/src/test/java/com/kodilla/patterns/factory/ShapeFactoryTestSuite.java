...
public class ShapeFactoryTestSuite {
    ...
    void testFactoryCircle() {
        ...
        //When
        Shape cirlce = factory.makeShape(ShapeFactory.CIRCLE);
        //Then
        assertEquals(Math.PI * Math.pow(4.50, 2.0), cirlce.getArea(), 0);
        assertEquals("The rounded circle", cirlce.getName());
    }
