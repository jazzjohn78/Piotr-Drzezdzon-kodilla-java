...
public class CrudAppTestSuite {
    private static final String  BASE_URL = "https://jazzjohn78.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("jazzjohn78@gmail.com");
        WebElement el = driverTrello.findElement(By.id("login"));
        el.submit();

        Thread.sleep(4000);

        driverTrello.findElement(By.id("password")).sendKeys("jazzjohn95");
